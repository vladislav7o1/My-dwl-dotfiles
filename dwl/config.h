...
static const uint32_t col_orange = 0xd65d0eff; /* gruvbox orange */
...
static const char *dmenucmd[] = {
    "rofi",
    "-show", "drun",
    "-theme", "/home/akiro/.config/rofi/launchers/type-2/style-4.rasi",
    NULL
};
static const char *screenshotcmd[] = {"/run/current-system/sw/bin/snip", NULL };
static const char *snip[] = { "/home/akiro/scripts/snip.sh", NULL };
...
static const Key keys[] = {
	...
	{ MODKEY, XKB_KEY_s, spawn, { .v = (const char*[]){ "/home/akiro/scripts/snip.sh", NULL } } },
